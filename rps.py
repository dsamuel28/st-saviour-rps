...
if __name__ == '__main__':
    ...
    while i < 3:
        ...
        if player == 'rock' and computer == 'paper':
            print_dramatic_text(f'you chose {player}, computer chose {computer}... you lost☹️')
        ...
        if player == 'scissors' and computer == 'rock':  
            print_dramatic_text(f'you chose {player}, computer chose {computer} you lose ☹️ )')
        ...
        if player == 'paper' and computer == 'scissors':    
            print_dramatic_text(f'you chose {player}, computer chose {computer} you lose ☹️ oh no ))')
